...
var RBY = {
    ...
    Arbok: { types: ['Poison' , 'Dragon'], bs: { hp: 70, at: 85, df: 70, sp: 85, sl: 65 }, weightkg: 65 },
    Arcanine: {
        types: ['Fire'],
    ...
    Beedrill: {
        types: ['Bug', 'Poison'],
        bs: { hp: 65, at: 100, df: 60, sp: 95, sl: 45 },
        weightkg: 29.5
    },
    Bellsprout: {
        types: ['Grass', 'Poison'],
    ...
    Blastoise: {
        types: ['Water', 'Steel'],
        bs: { hp: 80, at: 62, df: 105, sp: 78, sl: 85 },
        weightkg: 85.5
    },
    Bulbasaur: {
        types: ['Grass', 'Poison'],
    ...
    Butterfree: {
        types: ['Bug', 'Flying'],
        bs: { hp: 60, at: 45, df: 60, sp: 70, sl: 80 },
        weightkg: 32
    },
    Caterpie: {
        types: ['Bug'],
    ...
    Charizard: {
        types: ['Fire', 'Dragon'],
        bs: { hp: 80, at: 120, df: 85, sp: 100, sl: 85 },
        weightkg: 90.5
    },
    Charmander: {
        types: ['Fire'],
    ...
    Dewgong: {
        types: ['Water', 'Ice'],
        bs: { hp: 90, at: 70, df: 90, sp: 70, sl: 95 },
        weightkg: 120
    },
    Diglett: {
        types: ['Ground'],
    ...
    Ditto: { types: ['Normal'], bs: { hp: 60, at: 48, df: 48, sp: 48, sl: 48 }, weightkg: 4 },
    Dodrio: {
        types: ['Dark', 'Flying'],
        bs: { hp: 80, at: 60, df: 70, sp: 100, sl: 60 },
        weightkg: 85.2
    },
    Doduo: {
        types: ['Normal', 'Flying'],
    ...
    Electrode: {
        ...
        bs: { hp: 60, at: 40, df: 70, sp: 140, sl: 80 },
        weightkg: 66.6
    },
    Exeggcute: {
        types: ['Grass', 'Psychic'],
    ...
    'Farfetch\u2019d': {
        ...
        bs: { hp: 62, at: 65, df: 95, sp: 65, sl: 58 },
        weightkg: 15
    },
    Fearow: {
        types: ['Fire', 'Flying'],
        bs: { hp: 75, at: 110, df: 75, sp: 100, sl: 61 },
        weightkg: 38
    },
    Flareon: { types: ['Fire'], bs: { hp: 65, at: 130, df: 60, sp: 95, sl: 110 }, weightkg: 25 },
    Gastly: {
        types: ['Ghost', 'Poison'],
    ...
    Golduck: { types: ['Water', 'Psychic'], bs: { hp: 80, at: 105, df: 80, sp: 85, sl: 80 }, weightkg: 76.6 },
    Golem: {
        types: ['Rock', 'Ground'],
    ...
    Jynx: {
        types: ['Ice', 'Psychic'],
        bs: { hp: 85, at: 50, df: 35, sp: 95, sl: 95 },
        weightkg: 40.6
    },
    Kabuto: {
        types: ['Rock', 'Water'],
    ...
    Kakuna: {
        types: ['Bug', 'Poison'],
        bs: { hp: 45, at: 35, df: 60, sp: 35, sl: 25 },
        weightkg: 10,
        nfe: true
    },
    Kangaskhan: {
    ...
    Koffing: {
        types: ['Poison' , 'Fairy'],
        bs: { hp: 40, at: 50, df: 95, sp: 35, sl: 60 },
        weightkg: 1,
        nfe: true
    },
    Krabby: {
    ...
    Magikarp: {
        types: ['Water'],
        bs: { hp: 1, at: 200, df: 1, sp: 210, sl: 20 },
        weightkg: 10,
        nfe: true
    },
    Magmar: {
    ...
    Mankey: {
        types: ['Fighting'],
        bs: { hp: 60, at: 80, df: 45, sp: 70, sl: 35 },
        weightkg: 28,
        nfe: true
    },
    ...
    Nidoking: {
        types: ['Poison', 'Ground'],
        bs: { hp: 90, at: 110, df: 80, sp: 85, sl: 75 },
        weightkg: 62
    },
    Nidoqueen: {
        types: ['Poison', 'Ground'],
        bs: { hp: 90, at: 75, df: 80, sp: 80, sl: 75 },
        weightkg: 60
    },
    'Nidoran-F': {
        types: ['Poison'],
    ...
    Omastar: {
        types: ['Rock', 'Water'],
        bs: { hp: 70, at: 50, df: 125, sp: 65, sl: 115 },
        weightkg: 35
    },
    Onix: {
        types: ['Rock', 'Ground'],
    ...
    Pidgeot: {
        ...
        bs: { hp: 84, at: 50, df: 75, sp: 101, sl: 70 },
        weightkg: 39.5
    },
    Pidgeotto: {
        types: ['Electric', 'Flying'],
        bs: { hp: 63, at: 40, df: 55, sp: 75, sl: 50 },
        weightkg: 30,
        nfe: true
    },
    Pidgey: {
    ...
    Pinsir: { types: ['Bug' , 'Fighting'], bs: { hp: 65, at: 125, df: 100, sp: 85, sl: 55 }, weightkg: 55 },
    Poliwag: {
        types: ['Water'],
    ...
    Primeape: {
        types: ['Fighting'],
        bs: { hp: 110, at: 105, df: 50, sp: 95, sl: 60 },
        weightkg: 32
    },
    Psyduck: {
        types: ['Water', 'Psychic'],
        bs: { hp: 50, at: 65, df: 50, sp: 55, sl: 50 },
        weightkg: 19.6,
        nfe: true
    },
    Raichu: {
    ...
    Rapidash: { types: ['Psychic' , 'Fairy'], bs: { hp: 65, at: 100, df: 70, sp: 105, sl: 80 }, weightkg: 95 },
    Raticate: {
        types: ['Normal'],
    ...
    Seaking: { types: ['Water'], bs: { hp: 80, at: 110, df: 65, sp: 70, sl: 80 }, weightkg: 39 },
    Seel: {
        types: ['Water'],
        bs: { hp: 65, at: 45, df: 65, sp: 45, sl: 70 },
        weightkg: 90,
        nfe: true
    },
    Shellder: {
    ...
    Spearow: {
        types: ['Fire', 'Flying'],
        bs: { hp: 60, at: 70, df: 55, sp: 80, sl: 31 },
        weightkg: 2,
        nfe: true
    },
    Squirtle: {
    ...
    Venusaur: {
        types: ['Grass', 'Poison'],
        bs: { hp: 80, at: 60, df: 105, sp: 80, sl: 100 },
        weightkg: 100
    },
    Victreebel: {
        types: ['Grass', 'Poison'],
        bs: { hp: 80, at: 115, df: 80, sp: 70, sl: 100 },
        weightkg: 15.5
    },
    Vileplume: {
        types: ['Grass', 'Poison'],
        bs: { hp: 80, at: 55, df: 95, sp: 50, sl: 100 },
        weightkg: 18.6
    },
    Voltorb: {
        types: ['Electric' , 'Grass'],
        bs: { hp: 50, at: 20, df: 50, sp: 100, sl: 55 },
        weightkg: 10.4,
        nfe: true
    },
    Vulpix: {
    ...
    Weezing: {
        types: ['Poison' , 'Fairy'],
        bs: { hp: 65, at: 75, df: 120, sp: 60, sl: 85 },
        weightkg: 9.5
    },
    Wigglytuff: {
        types: ['Normal'],
        bs: { hp: 140, at: 70, df: 65, sp: 45, sl: 50 },
        weightkg: 12
    },
    Zapdos: {
        types: ['Electric', 'Flying'],
...
var GSC_PATCH = {
    ...
    Muk: { bs: { sa: 65, sd: 100 } },
    Nidoking: { bs: { sa: 75, sd: 75 } },
    Nidoqueen: { bs: { sa: 105, sd: 85 } },
    ...
    Venusaur: { bs: { sa: 105, sd: 105 } },
    Victreebel: { bs: { sa: 65, sd: 60 } },
    Vileplume: { bs: { sa: 100, sd: 100 } },
    ...
    Weezing: { bs: { sa: 100, sd: 70 } },
    Wigglytuff: { bs: { sa: 75, sd: 65 } },
    ...
    Ariados: {
        types: ['Bug', 'Poison'],
        bs: { hp: 70, at: 100, df: 70, sa: 60, sd: 70, sp: 75 },
        weightkg: 33.5
    },
    Azumarill: {
        types: ['Water'],
        bs: { hp: 100, at: 60, df: 80, sa: 50, sd: 80, sp: 50 },
        weightkg: 28.5
    },
    Bayleef: {
        types: ['Grass'],
    ...
    Bellossom: {
        types: ['Grass', 'Fairy'],
        bs: { hp: 80, at: 55, df: 85, sa: 110, sd: 100, sp: 50 },
        weightkg: 5.8
    },
    Blissey: {
        types: ['Normal'],
    ...
    Corsola: {
        types: ['Water', 'Ghost'],
        bs: { hp: 65, at: 50, df: 85, sa: 90, sd: 85, sp: 35 },
        weightkg: 5
    },
    Crobat: {
        types: ['Poison', 'Flying'],
    ...
    Delibird: {
        types: ['Ice', 'Flying'],
        bs: { hp: 75, at: 55, df: 75, sa: 135, sd: 75, sp: 86 },
        weightkg: 16
    },
    Donphan: {
        types: ['Ground'],
    ...
    Feraligatr: {
        types: ['Water' , 'Dark'],
        bs: { hp: 85, at: 115, df: 100, sa: 69, sd: 83, sp: 78 },
        weightkg: 88.8
    },
    Flaaffy: {
        types: ['Electric'],
    ...
    Furret: { types: ['Normal'], bs: { hp: 85, at: 110, df: 65, sa: 45, sd: 75, sp: 120 }, weightkg: 32.5 },
    Girafarig: {
    ...
    Granbull: {
        types: ['Normal'],
        bs: { hp: 90, at: 120, df: 75, sa: 50, sd: 65, sp: 80 },
        weightkg: 48.7
    },
    Heracross: {
        types: ['Bug', 'Fighting'],
    ...
    Hitmontop: {
        types: ['Fighting'],
        bs: { hp: 60, at: 95, df: 95, sa: 35, sd: 110, sp: 70 },
        weightkg: 48
    },
    'Ho-Oh': {
        types: ['Fire', 'Flying'],
    ...
    Jumpluff: {
        types: ['Grass', 'Flying'],
        bs: { hp: 75, at: 50, df: 70, sa: 80, sd: 95, sp: 110 },
        weightkg: 3
    },
    Kingdra: {
        types: ['Water', 'Dragon'],
        bs: { hp: 85, at: 70, df: 95, sa: 110, sd: 95, sp: 85 },
        weightkg: 152
    },
    Lanturn: {
        types: ['Water', 'Electric'],
    ...
    Ledian: {
        types: ['Bug', 'Fighting'],
        bs: { hp: 55, at: 85, df: 50, sa: 5, sd: 110, sp: 85 },
        weightkg: 35.6
    },
    Ledyba: {
        types: ['Bug', 'Flying'],
    ...
    Magcargo: {
        types: ['Fire', 'Water'],
        bs: { hp: 60, at: 50, df: 120, sa: 100, sd: 80, sp: 30 },
        weightkg: 55
    },
    Mantine: {
        types: ['Water', 'Flying'],
    ...
    Marill: {
        types: ['Water'],
        bs: { hp: 70, at: 30, df: 50, sa: 40, sd: 50, sp: 40 },
        weightkg: 8.5,
        nfe: true
    },
    Meganium: {
        types: ['Grass' , 'Dragon'],
        bs: { hp: 80, at: 50, df: 100, sa: 115, sd: 100, sp: 80 },
        weightkg: 100.5
    },
    Miltank: {
        types: ['Normal'],
    ...
    Misdreavus: {
        types: ['Ghost'],
        bs: { hp: 50, at: 45, df: 50, sa: 70, sd: 65, sp: 65 },
        weightkg: 1
    },
    Murkrow: {
        types: ['Dark', 'Flying'],
    ...
    Octillery: {
        types: ['Water' , 'Poison'],
        bs: { hp: 75, at: 105, df: 75, sa: 75, sd: 75, sp: 90 },
        weightkg: 28.5
    },
    Phanpy: {
        types: ['Ground'],
    ...
    Politoed: {
        types: ['Water'],
        bs: { hp: 90, at: 70, df: 85, sa: 95, sd: 100, sp: 70 },
        weightkg: 33.9
    },
    Porygon2: {
        types: ['Normal'],
    ...
    Quagsire: {
        types: ['Water', 'Ground'],
        bs: { hp: 95, at: 90, df: 90, sa: 65, sd: 65, sp: 35 },
        weightkg: 75
    },
    Quilava: {
        types: ['Fire'],
    ...
    Qwilfish: {
        types: ['Water', 'Poison'],
        bs: { hp: 65, at: 95, df: 85, sa: 40, sd: 70, sp: 85 },
        weightkg: 3.9
    },
    Raikou: {
        types: ['Electric'],
    ...
    Slowking: {
        types: ['Water', 'Psychic'],
        bs: { hp: 90, at: 75, df: 80, sa: 100, sd: 110, sp: 30 },
        weightkg: 79.5
    },
    Slugma: {
        types: ['Fire'],
    ...
    Spinarak: {
        types: ['Bug', 'Poison'],
        bs: { hp: 50, at: 60, df: 40, sa: 40, sd: 40, sp: 60 },
        weightkg: 8.5,
        nfe: true
    },
    Stantler: {
        types: ['Normal' , 'Psychic'],
        bs: { hp: 75, at: 100, df: 75, sa: 70, sd: 75, sp: 85 },
        weightkg: 71.2
    },
    Steelix: {
        types: ['Steel', 'Ground'],
    ...
    Sunflora: {
        types: ['Grass' , 'Fire'],
        bs: { hp: 80, at: 75, df: 80, sa: 120, sd: 85, sp: 30 },
        weightkg: 8.5
    },
    Sunkern: {
        types: ['Grass'],
    ...
    Swinub: {
        types: ['Ice', 'Ground'],
        bs: { hp: 70, at: 65, df: 60, sa: 30, sd: 50, sp: 50 },
        weightkg: 6.5,
        nfe: true
    },
    Teddiursa: {
    ...
    Typhlosion: {
        types: ['Fire' , 'Ghost'],
        bs: { hp: 78, at: 74, df: 78, sa: 119, sd: 85, sp: 100 },
        weightkg: 79.5
    },
    Tyranitar: {
        types: ['Rock', 'Dark'],
    ...
    Tyrogue: {
        types: ['Fighting'],
        bs: { hp: 50, at: 60, df: 55, sa: 35, sd: 55, sp: 55 },
        weightkg: 21,
        nfe: true
    },
    ...
    Unown: {
        types: ['Psychic'],
        bs: { hp: 70, at: 70, df: 70, sa: 140, sd: 70, sp: 100 },
        weightkg: 5,
        gender: 'N'
    },
    Ursaring: {
    ...
    Wooper: {
        types: ['Water', 'Ground'],
        bs: { hp: 70, at: 55, df: 65, sa: 25, sd: 45, sp: 15 },
        weightkg: 8.5,
        nfe: true
    },
    Xatu: {
        types: ['Psychic', 'Flying'],
        bs: { hp: 75, at: 55, df: 70, sa: 105, sd: 70, sp: 95 },
        weightkg: 15
    },
    Yanma: {
        types: ['Bug', 'Flying'],
...
var ADV_PATCH = {
    ...
    Articuno: { abilities: { 0: 'Natural Cure' } },
    Beedrill: { abilities: { 0: 'Sheer Force' } },
    ...
    Charizard: { abilities: { 0: 'Tough Claws' } },
    ...
    Ditto: { abilities: { 0: 'Imposter' } },
    Dodrio: { abilities: { 0: 'Quick Feet' } },
    ...
    'Farfetch\u2019d': { abilities: { 0: 'Scrappy' } },
    Fearow: { abilities: { 0: 'Super Luck' } },
    ...
    Golduck: { abilities: { 0: 'Tough Claws' } },
    ...
    Hitmonlee: { abilities: { 0: 'Unburden' } },
    ...
    Magikarp: { abilities: { 0: 'Adaptability' } },
    ...
    Moltres: { abilities: { 0: 'Turboblaze' } },
    ...
    Onix: { abilities: { 0: 'Sheer Force' } },
    Paras: { abilities: { 0: 'Effect Spore' } },
    Parasect: { abilities: { 0: 'Effect Spore' } },
    Persian: { abilities: { 0: 'Limber' } },
    Pidgeot: { abilities: { 0: 'Lightning Rod' } },
    Pidgeotto: { abilities: { 0: 'Static' } },
    ...
    Psyduck: { abilities: { 0: 'Tough Claws' } },
    Raichu: { abilities: { 0: 'Static' } },
    Rapidash: { abilities: { 0: 'Flash Fire' } },
    Raticate: { abilities: { 0: 'Run Away' } },
    Rattata: { abilities: { 0: 'Run Away' } },
    Rhydon: { abilities: { 0: 'Solid Rock' } },
    Rhyhorn: { abilities: { 0: 'Solid Rock' } },
    ...
    Starmie: { abilities: { 0: 'Clear Body' } },
    ...
    Venomoth: { abilities: { 0: 'Tinted Lens' } },
    ...
    Zapdos: { abilities: { 0: 'Teravolt' } },
    Zubat: { abilities: { 0: 'Inner Focus' } },
    Aipom: { abilities: { 0: 'Technician' } },
    ...
    Octillery: { abilities: { 0: 'Skill Link' } },
    Phanpy: { abilities: { 0: 'Battle Armor' } },
    ...
    Skiploom: { abilities: { 0: 'Infiltrator' } },
    Slowking: { abilities: { 0: 'Shell Armor' } },
    Slugma: { abilities: { 0: 'Magma Armor' } },
    Smeargle: { abilities: { 0: 'Own Tempo' } },
    Smoochum: { abilities: { 0: 'Oblivious' } },
    Sneasel: { abilities: { 0: 'Tough Claws' } },
    Snubbull: { abilities: { 0: 'Intimidate' } },
    Spinarak: { abilities: { 0: 'Sniper' } },
    Stantler: { abilities: { 0: 'Intimidate' } },
    Steelix: { abilities: { 0: 'Sheer Force' } },
    Sudowoodo: { abilities: { 0: 'Sturdy' } },
    Suicune: { abilities: { 0: 'Natural Cure' } },
    Sunflora: { abilities: { 0: 'Analytic' } },
    Sunkern: { abilities: { 0: 'Chlorophyll' } },
    Swinub: { abilities: { 0: 'Thick Fat' } },
    ...
    Tyranitar: { abilities: { 0: 'Inner Focus' } },
    Tyrogue: { abilities: { 0: 'Guts' } },
    Umbreon: { abilities: { 0: 'Prankster' } },
    ...
    Absol: {
        types: ['Dark'],
        bs: { hp: 70, at: 125, df: 70, sa: 75, sd: 70, sp: 90 },
        weightkg: 47,
    ...
    Altaria: {
        types: ['Dragon', 'Flying'],
        bs: { hp: 85, at: 70, df: 115, sa: 80, sd: 120, sp: 80 },
        weightkg: 20.6,
    ...
    Armaldo: {
        types: ['Rock', 'Bug'],
        bs: { hp: 75, at: 125, df: 100, sa: 45, sd: 80, sp: 70 },
        weightkg: 68.2,
        abilities: { 0: 'Battle Armor' }
    },
    Aron: {
    ...
    Banette: {
        ...
        bs: { hp: 80, at: 115, df: 80, sa: 50, sd: 80, sp: 105 },
        weightkg: 12.5,
    ...
    Beautifly: {
        types: ['Bug', 'Flying'],
        bs: { hp: 60, at: 50, df: 70, sa: 90, sd: 70, sp: 85 },
        weightkg: 28.4,
    ...
    Cacturne: {
        types: ['Grass', 'Dark'],
        bs: { hp: 90, at: 130, df: 80, sa: 60, sd: 80, sp: 90 },
        weightkg: 77.4,
        abilities: { 0: 'Sand Veil' }
    },
    Camerupt: {
        types: ['Fire', 'Ground'],
        bs: { hp: 70, at: 50, df: 100, sa: 95, sd: 105, sp: 40 },
        weightkg: 220,
    ...
    Chimecho: {
        types: ['Psychic', 'Steel'],
        bs: { hp: 85, at: 50, df: 80, sa: 105, sd: 90, sp: 65 },
        weightkg: 1,
        abilities: { 0: 'Levitate' }
    },
    Clamperl: {
    ...
    Crawdaunt: {
        types: ['Water', 'Dark'],
        bs: { hp: 90, at: 120, df: 85, sa: 50, sd: 55, sp: 65 },
        weightkg: 32.8,
        abilities: { 0: 'Sheer Force' }
    },
    Delcatty: {
        types: ['Normal', 'Fairy'],
        bs: { hp: 88, at: 50, df: 65, sa: 101, sd: 65, sp: 70 },
        weightkg: 32.6,
    ...
    Dustox: {
        types: ['Bug', 'Poison'],
        bs: { hp: 60, at: 40, df: 90, sa: 70, sd: 90, sp: 65 },
        weightkg: 31.6,
        abilities: { 0: 'Multiscale' }
    },
    Electrike: {
        types: ['Electric' , 'Fire'],
        bs: { hp: 45, at: 45, df: 50, sa: 65, sd: 50, sp: 65 },
        weightkg: 15.2,
        nfe: true,
        abilities: { 0: 'Static' }
    },
    Exploud: {
        types: ['Normal'],
        bs: { hp: 104, at: 60, df: 73, sa: 105, sd: 63, sp: 80 },
        weightkg: 84,
    ...
    Flygon: {
        types: ['Bug', 'Dragon'],
        bs: { hp: 80, at: 50, df: 80, sa: 130, sd: 80, sp: 105 },
        weightkg: 82,
        abilities: { 0: 'Levitate' }
    },
    Gardevoir: {
        types: ['Psychic'],
        bs: { hp: 70, at: 60, df: 70, sa: 125, sd: 115, sp: 80 },
        weightkg: 48.4,
        abilities: { 0: 'Synchronize' }
    },
    Glalie: {
        types: ['Ice', 'Dark'],
        bs: { hp: 80, at: 110, df: 90, sa: 60, sd: 80, sp: 80 },
        weightkg: 256.5,
        abilities: { 0: 'Intimidate' }
    },
    Gorebyss: {
        types: ['Water', 'Psychic'],
        bs: { hp: 65, at: 50, df: 75, sa: 115, sd: 105, sp: 75 },
        weightkg: 22.6,
        abilities: { 0: 'Swift Swim' }
    },
    Groudon: {
    ...
    Grumpig: {
        types: ['Psychic' , 'Dark'],
        bs: { hp: 80, at: 45, df: 65, sa: 100, sd: 110, sp: 95 },
        weightkg: 71.5,
        abilities: { 0: 'Thick Fat' }
    },
    Gulpin: {
    ...
    Huntail: {
        types: ['Water', 'Dark'],
        bs: { hp: 65, at: 115, df: 105, sa: 50, sd: 75, sp: 75 },
        weightkg: 27,
        abilities: { 0: 'Swift Swim' }
    },
    Illumise: {
        types: ['Bug' , 'Electric'],
        bs: { hp: 70, at: 45, df: 55, sa: 95, sd: 75, sp: 101 },
    ...
    Kecleon: {
        types: ['Normal'],
        bs: { hp: 80, at: 105, df: 70, sa: 60, sd: 120, sp: 40 },
        weightkg: 22,
        abilities: { 0: 'Protean' }
    },
    Kirlia: {
    ...
    Lombre: {
        types: ['Water', 'Grass'],
        bs: { hp: 60, at: 35, df: 60, sa: 65, sd: 70, sp: 50 },
        weightkg: 32.5,
        nfe: true,
        abilities: { 0: 'Swift Swim' }
    },
    ...
    Ludicolo: {
        types: ['Water', 'Grass'],
        bs: { hp: 80, at: 50, df: 75, sa: 105, sd: 100, sp: 70 },
        weightkg: 55,
        abilities: { 0: 'Swift Swim' }
    },
    Lunatone: {
        types: ['Rock', 'Ghost'],
        bs: { hp: 70, at: 55, df: 65, sa: 110, sd: 90, sp: 70 },
        weightkg: 168,
        abilities: { 0: 'Levitate' },
        gender: 'N'
    },
    ...
    Manectric: {
        types: ['Electric' , 'Fire'],
        bs: { hp: 70, at: 55, df: 70, sa: 105, sd: 70, sp: 105 },
        weightkg: 40.2,
        abilities: { 0: 'Lightning Rod' }
    },
    Marshtomp: {
    ...
    Masquerain: {
        types: ['Bug', 'Flying'],
        bs: { hp: 70, at: 50, df: 85, sa: 80, sd: 95, sp: 80 },
        weightkg: 3.6,
        abilities: { 0: 'Intimidate' }
    },
    Mawile: {
        types: ['Steel'],
        bs: { hp: 60, at: 105, df: 105, sa: 55, sd: 75, sp: 50 },
        weightkg: 11.5,
        abilities: { 0: 'Sheer Force' }
    },
    Medicham: {
        types: ['Fighting', 'Psychic'],
        bs: { hp: 70, at: 65, df: 75, sa: 60, sd: 75, sp: 80 },
        weightkg: 31.5,
        abilities: { 0: 'Pure Power' }
    },
    Meditite: {
        types: ['Fighting', 'Psychic'],
        bs: { hp: 50, at: 40, df: 55, sa: 40, sd: 55, sp: 60 },
        weightkg: 11.2,
        nfe: true,
        abilities: { 0: 'Pure Power' }
    },
    ...
    Mightyena: {
        types: ['Dark'],
        bs: { hp: 85, at: 100, df: 80, sa: 60, sd: 70, sp: 75 },
        weightkg: 37,
        abilities: { 0: 'Intimidate' }
    },
    Milotic: {
    ...
    Minun: {
        types: ['Electric'],
        bs: { hp: 255, at: 1, df: 255, sa: 1, sd: 255, sp: 1 },
        weightkg: 4.2,
    ...
    Ninjask: {
        types: ['Bug', 'Flying'],
        bs: { hp: 61, at: 110, df: 60, sa: 50, sd: 60, sp: 160 },
        weightkg: 12,
    ...
    Pelipper: {
        types: ['Water', 'Flying'],
        bs: { hp: 80, at: 50, df: 100, sa: 85, sd: 70, sp: 65 },
        weightkg: 28,
        abilities: { 0: 'Multiscale' }
    },
    Plusle: {
    ...
    Relicanth: {
        types: ['Water', 'Rock'],
        bs: { hp: 100, at: 90, df: 130, sa: 45, sd: 65, sp: 65 },
        weightkg: 23.4,
        abilities: { 0: 'Swift Swim' }
    },
    Roselia: {
    ...
    Sableye: {
        types: ['Dark', 'Ghost'],
        bs: { hp: 70, at: 75, df: 100, sa: 55, sd: 100, sp: 50 },
        weightkg: 11,
    ...
    Seviper: {
        types: ['Poison' , 'Fire'],
        bs: { hp: 84, at: 105, df: 78, sa: 50, sd: 78, sp: 95 },
        weightkg: 52.5,
        abilities: { 0: 'Merciless' }
    },
    Sharpedo: {
        types: ['Water', 'Dark'],
        bs: { hp: 70, at: 120, df: 65, sa: 65, sd: 65, sp: 95 },
        weightkg: 88.8,
        abilities: { 0: 'Strong Jaw' }
    },
    Shedinja: {
        types: ['Bug', 'Ghost'],
        bs: { hp: 1, at: 1, df: 1, sa: 1, sd: 1, sp: 255 },
        weightkg: 1.2,
    ...
    Shuppet: {
        types: ['Ghost' , 'Fighting'],
        bs: { hp: 50, at: 75, df: 50, sa: 40, sd: 45, sp: 75 },
        weightkg: 2.3,
        nfe: true,
        abilities: { 0: 'Tough Claws' }
    },
    ...
    Solrock: {
        types: ['Rock', 'Fire'],
        bs: { hp: 70, at: 110, df: 90, sa: 55, sd: 65, sp: 70 },
        weightkg: 154,
        abilities: { 0: 'Levitate' },
        gender: 'N'
    },
    ...
    Surskit: {
        types: ['Bug', 'Water'],
        bs: { hp: 60, at: 30, df: 55, sa: 70, sd: 60, sp: 65 },
        weightkg: 1.7,
        nfe: true,
        abilities: { 0: 'Swift Swim' }
    },
    ...
    Torkoal: {
        types: ['Fire'],
        bs: { hp: 70, at: 75, df: 140, sa: 95, sd: 70, sp: 20 },
        weightkg: 80.4,
        abilities: { 0: 'Shell Armor' }
    },
    Trapinch: {
    ...
    Tropius: {
        types: ['Ground', 'Flying'],
        bs: { hp: 90, at: 60, df: 80, sa: 110, sd: 90, sp: 70 },
        weightkg: 100,
        abilities: { 0: 'Chlorophyll' }
    },
    Vibrava: {
    ...
    Volbeat: {
        types: ['Bug' , 'Dark'],
        bs: { hp: 70, at: 95, df: 75, sa: 45, sd: 85, sp: 101 },
        weightkg: 17.7,
        abilities: { 0: 'Serene Grace' }
    },
    Wailmer: {
    ...
    Wailord: {
        types: ['Water'],
        bs: { hp: 170, at: 60, df: 55, sa: 100, sd: 55, sp: 1 },
        weightkg: 398,
    ...
    Whiscash: {
        types: ['Water', 'Ground'],
        bs: { hp: 110, at: 95, df: 75, sa: 60, sd: 75, sp: 70 },
        weightkg: 23.6,
        abilities: { 0: 'Damp' }
    },
    Whismur: {
    ...
    Wingull: {
        types: ['Water', 'Flying'],
        bs: { hp: 50, at: 40, df: 70, sa: 60, sd: 60, sp: 65 },
        weightkg: 9.5,
        nfe: true,
        abilities: { 0: 'Multiscale' }
    },
    ...
    Zangoose: {
        types: ['Dark' , 'Fairy'],
        bs: { hp: 73, at: 115, df: 69, sa: 60, sd: 69, sp: 104 },
        weightkg: 40.3,
...
var DPP_PATCH = {
    ...
    Abomasnow: {
        types: ['Grass', 'Ice'],
        bs: { hp: 90, at: 105, df: 75, sa: 60, sd: 95, sp: 75 },
        weightkg: 135.5,
        abilities: { 0: 'Fur Coat' }
    },
    Ambipom: {
        types: ['Normal'],
        bs: { hp: 75, at: 105, df: 75, sa: 50, sd: 75, sp: 115 },
        weightkg: 20.3,
        abilities: { 0: 'Technician' }
    },
    Arceus: {
    ...
    Bastiodon: {
        types: ['Rock', 'Steel'],
        bs: { hp: 120, at: 72, df: 138, sa: 27, sd: 108, sp: 30 },
        weightkg: 149.5,
        abilities: { 0: 'Sturdy' }
    },
    Bibarel: {
    ...
    Carnivine: {
        types: ['Grass', 'Dark'],
        bs: { hp: 80, at: 105, df: 75, sa: 50, sd: 75, sp: 92 },
        weightkg: 27,
    ...
    'Cherrim-Sunshine': {
        types: ['Grass', 'Fire'],
        bs: { hp: 70, at: 60, df: 70, sa: 127, sd: 78, sp: 115 },
        weightkg: 9.3,
        abilities: { 0: 'Flower Gift' },
        baseSpecies: 'Cherrim'
    },
    ...
    Croagunk: {
        ...
        bs: { hp: 55, at: 70, df: 50, sa: 50, sd: 50, sp: 55 },
        weightkg: 23,
        nfe: true,
    ...
    Dusknoir: {
        types: ['Ghost'],
        bs: { hp: 60, at: 100, df: 135, sa: 50, sd: 135, sp: 45 },
        weightkg: 106.6,
        abilities: { 0: 'Iron Fist' }
    },
    Electivire: {
    ...
    Floatzel: {
        types: ['Water', 'Fighting'],
        bs: { hp: 85, at: 105, df: 65, sa: 55, sd: 65, sp: 115 },
        weightkg: 33.5,
        abilities: { 0: 'Swift Swim' }
    },
    Froslass: {
        types: ['Ice', 'Ghost'],
        bs: { hp: 70, at: 50, df: 70, sa: 110, sd: 90, sp: 110 },
        weightkg: 26.6,
        abilities: { 0: 'Levitate' }
    },
    Gabite: {
    ...
    Gallade: {
        types: ['Psychic', 'Fighting'],
        bs: { hp: 70, at: 125, df: 70, sa: 60, sd: 90, sp: 105 },
        weightkg: 52,
    ...
    Honchkrow: {
        types: ['Dark', 'Flying'],
        bs: { hp: 100, at: 125, df: 62, sa: 85, sd: 62, sp: 71 },
        weightkg: 27.3,
    ...
    Kricketot: {
        types: ['Bug', 'Ground'],
        bs: { hp: 60, at: 70, df: 60, sa: 25, sd: 60, sp: 70 },
        weightkg: 2.2,
        nfe: true,
        abilities: { 0: 'Technician' }
    },
    Kricketune: {
        types: ['Bug', 'Ground'],
        bs: { hp: 80, at: 110, df: 80, sa: 55, sd: 80, sp: 95 },
        weightkg: 25.5,
        abilities: { 0: 'Technician' }
    },
    Krilowatt: {
    ...
    Lopunny: {
        types: ['Normal', 'Fighting'],
        bs: { hp: 65, at: 105, df: 70, sa: 50, sd: 90, sp: 105 },
        weightkg: 33.3,
        abilities: { 0: 'Iron Fist' }
    },
    Lucario: {
        types: ['Fighting', 'Steel'],
        bs: { hp: 70, at: 110, df: 70, sa: 115, sd: 70, sp: 100 },
        weightkg: 54,
        abilities: { 0: 'Iron Fist' }
    },
    Lumineon: {
        types: ['Water', 'Bug'],
        bs: { hp: 70, at: 50, df: 90, sa: 90, sd: 100, sp: 85 },
        weightkg: 24,
        abilities: { 0: 'Swift Swim' }
    },
    Luxio: {
    ...
    Mesprit: {
        types: ['Fairy', 'Fire'],
        bs: { hp: 80, at: 135, df: 75, sa: 105, sd: 75, sp: 110 },
        weightkg: 0.3,
        abilities: { 0: 'Levitate' },
        gender: 'N'
    },
    ...
    Pachirisu: {
        types: ['Electric'],
        bs: { hp: 90, at: 45, df: 100, sa: 45, sd: 100, sp: 100 },
        weightkg: 3.9,
        abilities: { 0: 'Volt Absorb' }
    },
    Palkia: {
    ...
    Phione: {
        types: ['Water'],
        bs: { hp: 80, at: 40, df: 120, sa: 60, sd: 120, sp: 60 },
        weightkg: 3.1,
    ...
    Purugly: {
        types: ['Normal', 'Electric'],
        bs: { hp: 70, at: 100, df: 78, sa: 55, sd: 70, sp: 112 },
        weightkg: 43.8,
        abilities: { 0: 'Thick Fat' }
    },
    Pyroak: {
    ...
    Rampardos: {
        types: ['Rock'],
        bs: { hp: 100, at: 150, df: 65, sa: 40, sd: 65, sp: 75 },
        weightkg: 102.5,
        abilities: { 0: 'Mold Breaker' }
    },
    Rebble: {
    ...
    Skuntank: {
        types: ['Poison', 'Dark'],
        bs: { hp: 103, at: 50, df: 67, sa: 105, sd: 61, sp: 97 },
        weightkg: 38,
        abilities: { 0: 'Stench' }
    },
    Snover: {
    ...
    Toxicroak: {
        types: ['Poison', 'Fighting'],
        bs: { hp: 90, at: 106, df: 65, sa: 79, sd: 65, sp: 90 },
        weightkg: 44.4,
        abilities: { 0: 'Dry Skin' }
    },
    Turtwig: {
...
var BW_PATCH = {
    ...
    Accelgor: {
        types: ['Bug'],
        bs: { hp: 80, at: 90, df: 40, sa: 110, sd: 60, sp: 145 },
        weightkg: 25.3,
        abilities: { 0: 'Unnerve' }
    },
    Alomomola: {
        types: ['Water'],
        bs: { hp: 165, at: 80, df: 80, sa: 40, sd: 80, sp: 40 },
        weightkg: 31.6,
        abilities: { 0: 'Healer' }
    },
    Amoonguss: {
    ...
    Archeops: {
        types: ['Rock', 'Flying'],
        bs: { hp: 75, at: 125, df: 65, sa: 50, sd: 65, sp: 115 },
        weightkg: 32,
        abilities: { 0: 'Pressure' }
    },
    Argalis: {
    ...
    Audino: {
        types: ['Normal', 'Fairy'],
        bs: { hp: 103, at: 60, df: 106, sa: 80, sd: 106, sp: 50 },
        weightkg: 31,
        abilities: { 0: 'Healer' }
    },
    Aurumoth: {
    ...
    Basculin: {
        types: ['Water', 'Normal'],
        bs: { hp: 90, at: 105, df: 65, sa: 50, sd: 65, sp: 110 },
        weightkg: 18,
        abilities: { 0: 'Reckless' },
    ...
    Beartic: {
        types: ['Ice', 'Dark'],
        bs: { hp: 95, at: 120, df: 90, sa: 50, sd: 80, sp: 70 },
        weightkg: 260,
        abilities: { 0: 'Swift Swim' }
    },
    Beheeyem: {
    ...
    Blitzle: {
        ...
        bs: { hp: 50, at: 65, df: 50, sa: 45, sd: 50, sp: 75 },
        weightkg: 29.8,
        nfe: true,
    ...
    Cinccino: {
        types: ['Normal', 'Fairy'],
        bs: { hp: 80, at: 105, df: 75, sa: 50, sd: 75, sp: 115 },
        weightkg: 7.5,
        abilities: { 0: 'Skill Link' }
    },
    Cobalion: {
    ...
    Cubchoo: {
        types: ['Ice'],
        bs: { hp: 55, at: 70, df: 60, sa: 50, sd: 60, sp: 40 },
        weightkg: 8.5,
        nfe: true,
        abilities: { 0: 'Swift Swim' }
    },
    ...
    Eelektross: {
        ...
        bs: { hp: 85, at: 115, df: 80, sa: 69, sd: 80, sp: 86 },
        weightkg: 80.5,
        abilities: { 0: 'Levitate' }
    },
    Elgyem: {
    ...
    Emolga: {
        types: ['Electric', 'Flying'],
        bs: { hp: 65, at: 55, df: 75, sa: 95, sd: 75, sp: 103 },
        weightkg: 5,
        abilities: { 0: 'Static' }
    },
    Escavalier: {
    ...
    Galvantula: {
        types: ['Bug', 'Electric'],
        bs: { hp: 70, at: 70, df: 65, sa: 105, sd: 67, sp: 108 },
        weightkg: 14.3,
        abilities: { 0: 'Compound Eyes' }
    },
    Garbodor: {
        types: ['Poison', 'Ground'],
        bs: { hp: 85, at: 105, df: 92, sa: 60, sd: 82, sp: 75 },
        weightkg: 107.3,
        abilities: { 0: 'Stench' }
    },
    Genesect: {
    ...
    Heatmor: {
        types: ['Fire'],
        bs: { hp: 85, at: 105, df: 80, sa: 60, sd: 80, sp: 70 },
        weightkg: 58,
        abilities: { 0: 'Tough Claws' }
    },
    Herdier: {
    ...
    Joltik: {
        types: ['Bug', 'Electric'],
        bs: { hp: 50, at: 50, df: 50, sa: 65, sd: 50, sp: 65 },
        weightkg: 0.6,
        nfe: true,
        abilities: { 0: 'Compound Eyes' }
    },
    ...
    Klinklang: {
        ...
        bs: { hp: 60, at: 70, df: 115, sa: 100, sd: 85, sp: 90 },
        weightkg: 81,
        gender: 'N',
        abilities: { 0: 'Clear Body' }
    },
    ...
    Leavanny: {
        types: ['Bug', 'Grass'],
        bs: { hp: 75, at: 105, df: 80, sa: 58, sd: 80, sp: 102 },
        weightkg: 20.5,
        abilities: { 0: 'Super Luck' }
    },
    Liepard: {
        types: ['Dark', 'Fairy'],
        bs: { hp: 65, at: 50, df: 75, sa: 105, sd: 75, sp: 110 },
        weightkg: 37.5,
        abilities: { 0: 'Prankster' }
    },
    Lilligant: {
    ...
    Maractus: {
        types: ['Grass', 'Ground'],
        bs: { hp: 75, at: 60, df: 80, sa: 100, sd: 80, sp: 60 },
        weightkg: 28,
        abilities: { 0: 'Water Absorb' }
    },
    Meloetta: {
    ...
    Sawk: {
        types: ['Fighting', 'Ice'],
        bs: { hp: 95, at: 125, df: 75, sa: 30, sd: 75, sp: 105 },
        weightkg: 51,
        abilities: { 0: 'Sturdy' }
    },
    Sawsbuck: {
    ...
    Seismitoad: {
        ...
        bs: { hp: 105, at: 100, df: 75, sa: 80, sd: 75, sp: 74 },
        weightkg: 62,
        abilities: { 0: 'Sand Rush' }
    },
    Serperior: {
        types: ['Grass', 'Dragon'],
        bs: { hp: 75, at: 75, df: 100, sa: 75, sd: 100, sp: 115 },
        weightkg: 63,
        abilities: { 0: 'Overgrow' }
    },
    Servine: {
    ...
    Sigilyph: {
        types: ['Psychic', 'Flying'],
        bs: { hp: 82, at: 58, df: 80, sa: 103, sd: 80, sp: 107 },
        weightkg: 14,
        abilities: { 0: 'Wonder Skin' }
    },
    Simipour: {
        types: ['Water', 'Ice'],
        bs: { hp: 105, at: 60, df: 90, sa: 85, sd: 90, sp: 70 },
        weightkg: 29,
        abilities: { 0: 'Storm Drain' }
    },
    Simisage: {
        types: ['Grass', 'Dark'],
        bs: { hp: 75, at: 105, df: 75, sa: 69, sd: 75, sp: 101 },
        weightkg: 30.5,
        abilities: { 0: 'Sap Sipper' }
    },
    Simisear: {
        types: ['Fire', 'Psychic'],
        bs: { hp: 75, at: 69, df: 75, sa: 105, sd: 75, sp: 101 },
        weightkg: 28,
        abilities: { 0: 'Flash Fire' }
    },
    Snivy: {
    ...
    Swanna: {
        types: ['Water', 'Flying'],
        bs: { hp: 75, at: 50, df: 90, sa: 95, sd: 90, sp: 100 },
        weightkg: 24.2,
        abilities: { 0: 'Serene Grace' }
    },
    Swoobat: {
        types: ['Psychic', 'Flying'],
        bs: { hp: 80, at: 50, df: 65, sa: 100, sd: 65, sp: 115 },
        weightkg: 10.5,
        abilities: { 0: 'Unaware' }
    },
    Tepig: {
    ...
    Throh: {
        types: ['Fighting', 'Fire'],
        bs: { hp: 120, at: 100, df: 105, sa: 30, sd: 105, sp: 45 },
        weightkg: 55.5,
        abilities: { 0: 'Guts' }
    },
    Thundurus: {
    ...
    'Thundurus-Therian': {
        types: ['Electric', 'Flying'],
        bs: { hp: 79, at: 105, df: 70, sa: 145, sd: 80, sp: 111 },
        weightkg: 61,
        abilities: { 0: 'Volt Absorb' },
    ...
    Tranquill: {
        types: ['Ice', 'Flying'],
        bs: { hp: 62, at: 50, df: 62, sa: 77, sd: 42, sp: 65 },
        weightkg: 15,
        nfe: true,
        abilities: { 0: 'Serene Grace' }
    },
    ...
    Unfezant: {
        types: ['Ice', 'Flying'],
        bs: { hp: 80, at: 59, df: 80, sa: 115, sd: 55, sp: 99 },
        weightkg: 29,
        abilities: { 0: 'Serene Grace' }
    },
    Vanillish: {
        types: ['Ice'],
        bs: { hp: 65, at: 51, df: 65, sa: 80, sd: 75, sp: 59 },
        weightkg: 41,
        nfe: true,
    ...
    Vanilluxe: {
        types: ['Ice', 'Fire'],
        bs: { hp: 95, at: 65, df: 85, sa: 110, sd: 95, sp: 85 },
        weightkg: 57.5,
        abilities: { 0: 'Ice Body' }
    },
    Venipede: {
    ...
    Watchog: {
        types: ['Normal', 'Poison'],
        bs: { hp: 65, at: 99, df: 75, sa: 55, sd: 80, sp: 111 },
        weightkg: 27,
        abilities: { 0: 'Prankster' }
    },
    Whimsicott: {
        types: ['Grass', 'Fairy'],
        bs: { hp: 67, at: 60, df: 85, sa: 77, sd: 75, sp: 116 },
        weightkg: 6.6,
        abilities: { 0: 'Prankster' }
    },
    Whirlipede: {
    ...
    Zebstrika: {
        types: ['Electric', 'Ground'],
        bs: { hp: 75, at: 105, df: 70, sa: 59, sd: 70, sp: 116 },
        weightkg: 79.5,
        abilities: { 0: 'Sap Sipper' }
    },
    Zekrom: {
    ...
    Zorua: {
        types: ['Normal', 'Ghost'],
        bs: { hp: 40, at: 64, df: 40, sa: 80, sd: 40, sp: 65 },
        weightkg: 12.5,
        abilities: { 0: 'Rattled' },
        nfe: true
    },
...
var XY_PATCH = {
    ...
    Aromatisse: {
        types: ['Fairy', 'Ground'],
        bs: { hp: 101, at: 61, df: 71, sa: 129, sd: 99, sp: 99 },
        weightkg: 15.5,
        abilities: { 0: 'Healer' }
    },
    Aurorus: {
    ...
    Dedenne: {
        ...
        bs: { hp: 70, at: 40, df: 69, sa: 95, sd: 80, sp: 101 },
        weightkg: 2.2,
        abilities: { 0: 'Static' }
    },
    Delphox: {
    ...
    Diggersby: {
        types: ['Normal', 'Ground'],
        bs: { hp: 85, at: 65, df: 77, sa: 50, sd: 77, sp: 81 },
        weightkg: 42.4,
    ...
    'Floette-Eternal': {
        types: ['Fairy'],
        bs: { hp: 74, at: 55, df: 67, sa: 125, sd: 128, sp: 102 },
        weightkg: 0.9,
    ...
    Gogoat: {
        types: ['Grass', 'Ice'],
        bs: { hp: 123, at: 116, df: 68, sa: 52, sd: 81, sp: 97 },
        weightkg: 91,
        abilities: { 0: 'Fluffy' }
    },
    Goodra: {
    ...
    'Gourgeist-Small': {
        types: ['Ghost', 'Grass'],
        bs: { hp: 55, at: 40, df: 122, sa: 111, sd: 75, sp: 99 },
        weightkg: 9.5,
    ...
    Greninja: {
        types: ['Water', 'Dark'],
        bs: { hp: 72, at: 125, df: 67, sa: 73, sd: 71, sp: 122 },
        weightkg: 40,
        abilities: { 0: 'Protean' }
    },
    Hawlucha: {
    ...
    Heliolisk: {
        ...
        bs: { hp: 62, at: 55, df: 65, sa: 109, sd: 94, sp: 109 },
        weightkg: 21,
    ...
    Malamar: {
        types: ['Dark', 'Psychic'],
        bs: { hp: 86, at: 92, df: 88, sa: 68, sd: 75, sp: 85 },
        weightkg: 47,
    ...
    'Aggron-Mega': {
        types: ['Steel'],
        bs: { hp: 70, at: 120, df: 180, sa: 40, sd: 70, sp: 50 },
        weightkg: 395,
        abilities: { 0: 'Filter' },
        baseSpecies: 'Aggron'
    },
    ...
    'Altaria-Mega': {
        types: ['Dragon', 'Fairy'],
        bs: { hp: 75, at: 110, df: 100, sa: 90, sd: 105, sp: 80 },
        weightkg: 20.6,
    ...
    'Banette-Mega': {
        types: ['Ghost' , 'Fighting'],
        bs: { hp: 80, at: 165, df: 80, sa: 50, sd: 85, sp: 120 },
        weightkg: 13,
        abilities: { 0: 'Tough Claws' },
        baseSpecies: 'Banette'
    },
    'Beedrill-Mega': {
        types: ['Bug', 'Poison'],
        bs: { hp: 65, at: 120, df: 70, sa: 15, sd: 80, sp: 145 },
        weightkg: 40.5,
        abilities: { 0: 'Adaptability' },
    ...
    'Blastoise-Mega': {
        types: ['Water' , 'Steel'],
        bs: { hp: 80, at: 90, df: 135, sa: 135, sd: 115, sp: 80 },
        weightkg: 101.1,
        abilities: { 0: 'Shell Armor' },
    ...
    'Camerupt-Mega': {
        types: ['Fire', 'Ground'],
        bs: { hp: 70, at: 75, df: 105, sa: 120, sd: 110, sp: 20 },
        weightkg: 320.5,
        abilities: { 0: 'Sheer Force' },
    ...
    'Charizard-Mega-Y': {
        types: ['Fire', 'Flying'],
        bs: { hp: 90, at: 90, df: 80, sa: 150, sd: 115, sp: 110 },
        weightkg: 100.5,
        abilities: { 0: 'Solar Power' },
        baseSpecies: 'Charizard'
    },
    ...
    'Gardevoir-Mega': {
        types: ['Psychic', 'Fairy'],
        bs: { hp: 70, at: 80, df: 70, sa: 165, sd: 135, sp: 100 },
        weightkg: 48.4,
        abilities: { 0: 'Pixilate' },
    ...
    'Glalie-Mega': {
        types: ['Ice', 'Dark'],
        bs: { hp: 80, at: 140, df: 95, sa: 60, sd: 95, sp: 110 },
        weightkg: 350.2,
        abilities: { 0: 'Refrigerate' },
        baseSpecies: 'Glalie'
    },
    ...
    'Lopunny-Mega': {
        types: ['Normal', 'Fighting'],
        bs: { hp: 65, at: 125, df: 83, sa: 5, sd: 96, sp: 126 },
        weightkg: 28.3,
        abilities: { 0: 'Iron Fist' },
        baseSpecies: 'Lopunny'
    },
    ...
    'Manectric-Mega': {
        types: ['Electric' , 'Fire'],
        bs: { hp: 70, at: 65, df: 80, sa: 145, sd: 80, sp: 135 },
        weightkg: 44,
        abilities: { 0: 'Intimidate' },
    ...
    'Mawile-Mega': {
        types: ['Steel', 'Fairy'],
        bs: { hp: 60, at: 105, df: 125, sa: 55, sd: 95, sp: 50 },
        weightkg: 23.5,
        abilities: { 0: 'Huge Power' },
        baseSpecies: 'Mawile'
    },
    ...
    'Pinsir-Mega': {
        types: ['Bug', 'Flying'],
        bs: { hp: 65, at: 155, df: 120, sa: 55, sd: 90, sp: 105 },
        weightkg: 59,
    ...
    'Sableye-Mega': {
        types: ['Dark', 'Ghost'],
        bs: { hp: 70, at: 85, df: 135, sa: 75, sd: 135, sp: 20 },
        weightkg: 161,
        abilities: { 0: 'Magic Bounce' },
        baseSpecies: 'Sableye'
    },
    ...
    'Sceptile-Mega': {
        types: ['Grass', 'Dragon'],
        bs: { hp: 70, at: 125, df: 75, sa: 120, sd: 85, sp: 145 },
        weightkg: 55.2,
        abilities: { 0: 'Technician' },
    ...
    'Sharpedo-Mega': {
        types: ['Water', 'Dark'],
        bs: { hp: 70, at: 140, df: 80, sa: 85, sd: 80, sp: 105 },
        weightkg: 130.3,
        abilities: { 0: 'Strong Jaw' },
    ...
    'Slowbro-Mega': {
        types: ['Water', 'Psychic'],
        bs: { hp: 95, at: 50, df: 150, sa: 115, sd: 80, sp: 10 },
        weightkg: 120,
        abilities: { 0: 'Shell Armor' },
        baseSpecies: 'Slowbro'
    },
    ...
    'Venusaur-Mega': {
        types: ['Grass', 'Poison'],
        bs: { hp: 80, at: 100, df: 125, sa: 125, sd: 125, sp: 80 },
        weightkg: 155.5,
        abilities: { 0: 'Thick Fat' },
    ...
    Pangoro: {
        types: ['Fighting', 'Dark'],
        bs: { hp: 95, at: 124, df: 84, sa: 50, sd: 84, sp: 58 },
        weightkg: 136,
        abilities: { 0: 'Iron Fist' }
    },
    Phantump: {
    ...
    Slurpuff: {
        types: ['Fairy', 'Fire'],
        bs: { hp: 82, at: 64, df: 75, sa: 101, sd: 86, sp: 72 },
        weightkg: 5,
        abilities: { 0: 'Unburden' }
    },
    Snugglow: {
    ...
    Talonflame: {
        types: ['Fire', 'Flying'],
        bs: { hp: 80, at: 100, df: 70, sa: 54, sd: 70, sp: 126 },
        weightkg: 24.5,
        abilities: { 0: 'Flame Body' }
    },
    Trevenant: {
...
var SM_PATCH = {
    ...
    Ariados: { bs: { sd: 70 } },
    Beartic: { bs: { at: 120 } },
    Chimecho: { bs: { hp: 85, df: 80, sd: 90 } },
    Corsola: { bs: { hp: 65, df: 100, sd: 110 } },
    ...
    Bruxish: {
        types: ['Water', 'Psychic'],
        bs: { hp: 78, at: 105, df: 70, sa: 55, sd: 70, sp: 97 },
        weightkg: 19,
    ...
    Dartrix: {
        types: ['Grass', 'Flying'],
        bs: { hp: 70, at: 75, df: 75, sa: 60, sd: 70, sp: 70 },
        weightkg: 16,
        nfe: true,
        abilities: { 0: 'Comatose' }
    },
    Decidueye: {
        types: ['Grass', 'Ghost'],
        bs: { hp: 90, at: 110, df: 75, sa: 70, sd: 100, sp: 85 },
        weightkg: 36.6,
        abilities: { 0: 'Grassy Surge' }
    },
    Dewpider: {
        types: ['Water', 'Bug'],
        bs: { hp: 50, at: 60, df: 55, sa: 40, sd: 75, sp: 20 },
        weightkg: 4,
        nfe: true,
        abilities: { 0: 'Water Bubble' }
    },
    ...
    'Dugtrio-Alola': {
        types: ['Ground', 'Steel'],
        bs: { hp: 70, at: 100, df: 70, sa: 50, sd: 80, sp: 110 },
        weightkg: 66.6,
        baseSpecies: 'Dugtrio',
        abilities: { 0: 'Sand Veil' }
    },
    ...
    Gumshoos: {
        types: ['Normal', 'Dark'],
        bs: { hp: 90, at: 110, df: 70, sa: 55, sd: 80, sp: 70 },
        weightkg: 14.2,
    ...
    Lycanroc: {
        types: ['Rock', 'Fighting'],
        bs: { hp: 85, at: 115, df: 75, sa: 55, sd: 75, sp: 112 },
        weightkg: 25,
    ...
    'Lycanroc-Dusk': {
        types: ['Rock', 'Fire'],
        bs: { hp: 75, at: 120, df: 75, sa: 55, sd: 75, sp: 117 },
        weightkg: 25,
        abilities: { 0: 'Tough Claws' },
    ...
    'Lycanroc-Midnight': {
        types: ['Rock', 'Dark'],
        bs: { hp: 95, at: 100, df: 95, sa: 55, sd: 90, sp: 82 },
        weightkg: 25,
        baseSpecies: 'Lycanroc',
        abilities: { 0: 'Stamina' }
    },
    ...
    'Marowak-Alola': {
        types: ['Fire', 'Ghost'],
        bs: { hp: 70, at: 95, df: 110, sa: 50, sd: 80, sp: 45 },
        weightkg: 34,
        abilities: { 0: 'Cursed Body' },
        baseSpecies: 'Marowak'
    },
    ...
    'Meowth-Alola': {
        types: ['Dark'],
        bs: { hp: 50, at: 35, df: 45, sa: 60, sd: 40, sp: 90 },
        weightkg: 4.2,
        baseSpecies: 'Meowth',
        nfe: true,
        abilities: { 0: 'Fur Coat' }
    ...
    'Ninetales-Alola': {
        types: ['Ice', 'Fairy'],
        bs: { hp: 80, at: 60, df: 75, sa: 95, sd: 100, sp: 110 },
        weightkg: 19.9,
        abilities: { 0: 'Refrigerate' },
    ...
    Oricorio: {
        types: ['Fire', 'Flying'],
        bs: { hp: 75, at: 70, df: 100, sa: 90, sd: 70, sp: 95 },
        weightkg: 3.4,
        abilities: { 0: 'Dancer' },
    ...
    'Oricorio-Pa\'u': {
        types: ['Psychic', 'Flying'],
        bs: { hp: 75, at: 65, df: 70, sa: 90, sd: 110, sp: 90 },
        weightkg: 3.4,
        abilities: { 0: 'Dancer' },
    ...
    'Oricorio-Pom-Pom': {
        types: ['Electric', 'Flying'],
        bs: { hp: 75, at: 70, df: 70, sa: 105, sd: 70, sp: 110 },
        weightkg: 3.4,
        abilities: { 0: 'Dancer' },
        baseSpecies: 'Oricorio'
    },
    'Oricorio-Sensu': {
        types: ['Ghost', 'Flying'],
        bs: { hp: 75, at: 65, df: 100, sa: 80, sd: 100, sp: 80 },
        weightkg: 3.4,
        abilities: { 0: 'Dancer' },
        baseSpecies: 'Oricorio'
    },
    ...
    'Persian-Alola': {
        types: ['Dark'],
        bs: { hp: 75, at: 50, df: 60, sa: 95, sd: 65, sp: 115 },
        weightkg: 33,
        baseSpecies: 'Persian',
        abilities: { 0: 'Fur Coat' }
    },
    ...
    'Raichu-Alola': {
        ...
        bs: { hp: 70, at: 65, df: 65, sa: 110, sd: 85, sp: 110 },
        weightkg: 21,
        baseSpecies: 'Raichu',
    ...
    'Raticate-Alola': {
        types: ['Dark', 'Normal'],
        bs: { hp: 85, at: 85, df: 70, sa: 40, sd: 80, sp: 90 },
        weightkg: 25.5,
    ...
    'Rattata-Alola': {
        types: ['Dark', 'Normal'],
        bs: { hp: 50, at: 60, df: 40, sa: 25, sd: 40, sp: 75 },
        weightkg: 3.8,
        baseSpecies: 'Rattata',
        nfe: true,
        abilities: { 0: 'Thick Fat' }
    ...
    Ribombee: {
        types: ['Bug', 'Fairy'],
        bs: { hp: 60, at: 55, df: 60, sa: 105, sd: 70, sp: 124 },
        weightkg: 0.5,
    ...
    Rockruff: {
        types: ['Rock'],
        bs: { hp: 65, at: 75, df: 55, sa: 30, sd: 55, sp: 60 },
        weightkg: 9.2,
        nfe: true,
        abilities: { 0: 'Unburden' }
    },
    Rowlet: {
        types: ['Grass', 'Flying'],
        bs: { hp: 60, at: 55, df: 55, sa: 50, sd: 50, sp: 50 },
        weightkg: 1.5,
        nfe: true,
        abilities: { 0: 'Comatose' }
    },
    Salandit: {
        types: ['Poison', 'Fire'],
        bs: { hp: 50, at: 40, df: 50, sa: 75, sd: 50, sp: 80 },
        weightkg: 4.8,
        nfe: true,
    ...
    Salazzle: {
        types: ['Poison', 'Fire'],
        bs: { hp: 70, at: 50, df: 70, sa: 115, sd: 70, sp: 120 },
        weightkg: 22.2,
    ...
    'Sandshrew-Alola': {
        types: ['Ice', 'Steel'],
        bs: { hp: 60, at: 75, df: 90, sa: 10, sd: 35, sp: 40 },
        weightkg: 40,
    ...
    'Sandslash-Alola': {
        types: ['Ice', 'Steel'],
        bs: { hp: 85, at: 100, df: 120, sa: 25, sd: 65, sp: 70 },
        weightkg: 55,
    ...
    Steenee: {
        types: ['Grass', 'Fighting'],
        bs: { hp: 60, at: 70, df: 50, sa: 40, sd: 50, sp: 65 },
        weightkg: 8.2,
        nfe: true,
        abilities: { 0: 'Technician' }
    },
    ...
    Togedemaru: {
        types: ['Electric', 'Steel'],
        bs: { hp: 75, at: 100, df: 65, sa: 40, sd: 75, sp: 100 },
        weightkg: 3.3,
        abilities: { 0: 'Iron Barbs' },
    ...
    Tsareena: {
        types: ['Grass', 'Fighting'],
        bs: { hp: 82, at: 120, df: 98, sa: 50, sd: 98, sp: 82 },
        weightkg: 21.4,
        abilities: { 0: 'Technician' }
    },
    Turtonator: {
        types: ['Fire', 'Dragon'],
        bs: { hp: 70, at: 60, df: 135, sa: 100, sd: 85, sp: 35 },
        weightkg: 212,
        abilities: { 0: 'Shell Armor' }
    },
    'Type: Null': {
    ...
    Vikavolt: {
        types: ['Bug', 'Electric'],
        bs: { hp: 65, at: 50, df: 90, sa: 130, sd: 75, sp: 90 },
        weightkg: 45,
        abilities: { 0: 'Levitate' },
    ...
    'Vulpix-Alola': {
        types: ['Ice'],
        bs: { hp: 60, at: 40, df: 45, sa: 60, sd: 65, sp: 65 },
        weightkg: 9.9,
        baseSpecies: 'Vulpix',
        nfe: true,
        abilities: { 0: 'Refrigerate' }
    ...
    Yungoos: {
        types: ['Normal', 'Dark'],
        bs: { hp: 55, at: 70, df: 45, sa: 30, sd: 50, sp: 60 },
        weightkg: 6,
        nfe: true,
        abilities: { 0: 'Tough Claws' }
    },
    ...
    'Zygarde-Complete': {
        types: ['Dragon', 'Ground'],
        bs: { hp: 216, at: 100, df: 121, sa: 81, sd: 95, sp: 95 },
        weightkg: 610,
...
exports.SPECIES = [{}, RBY, GSC, ADV, DPP, BW, XY, SM];
