...
var RBY = {
    ...
    Fissure: { bp: 140, type: 'Ground' , recoil: [44, 100] },
    ...
    Guillotine: { bp: 100, type: 'Normal' , secondaries: true},
    ...
    Sludge: { bp: 25, type: 'Poison' , multihit: [2, 5] },
    ...
    'Vine Whip': { bp: 35, type: 'Grass' , willCrit: true },
    ...
    'Drill Peck': { bp: 80, type: 'Flying' , secondaries: true },
    ...
    'Mega Kick': { bp: 140, type: 'Fighting', recoil: [44, 100]},
    ...
    Slam: { bp: 80, type: 'Normal' , secondaries: true },
    Smokescreen: { bp: 0, category: 'Status', type: 'Normal' },
    Splash: { bp: 140 , type: 'Water' , recoil: [44, 100] },
    Strength: { bp: 80, type: 'Rock' , secondaries: true },
    'Thunder Punch': { bp: 75, type: 'Electric' },
    'Thunder Shock': { bp: 40, type: 'Electric' },
    'Vise Grip': { bp: 55, type: 'Normal' },
    'Water Gun': { bp: 70, type: 'Water' },
...
var GSC_PATCH = {
    ...
    'Sonic Boom': { bp: 0 },
    'Super Fang': { bp: 0 },
    'Wing Attack': { bp: 40, multihit: 2 },
    Aeroblast: { bp: 100, type: 'Flying' , secondaries: true },
    ...
    'Cross Chop': { bp: 90, type: 'Fighting' },
    ...
    'Rapid Spin': { bp: 40, type: 'Normal' , secondaries: true },
    ...
    'Flame Wheel': { bp: 25, type: 'Fire' , multihit: [2, 5] },
    'Iron Tail': { bp: 100, type: 'Steel' },
    'Mach Punch': { bp: 40, type: 'Fighting', priority: 1 },
    Megahorn: { bp: 140, type: 'Bug' , recoil: [44, 100] },
    'Metal Claw': { bp: 60, type: 'Steel' },
    'Mud-Slap': { bp: 40, type: 'Ground' },
    ...
    Spark: { bp: 25, type: 'Electric' , multihit: [2, 5] },
...
var ADV_PATCH = {
    ...
    'Blast Burn': { bp: 140, type: 'Fire' , recoil: [44, 100] },
    ...
    'Frenzy Plant': { bp: 140, type: 'Grass' , recoil: [44, 100] },
    Grudge: { bp: 0, category: 'Status', type: 'Ghost' },
    'Helping Hand': { bp: 0, category: 'Status', type: 'Normal', priority: 5 },
    'Hydro Cannon': { bp: 140, type: 'Water' , recoil: [44, 100] },
    'Iron Defense': { bp: 0, category: 'Status', type: 'Steel' },
    'Magical Leaf': { bp: 75, type: 'Grass' , secondaries: true },
    'Mud Shot': { bp: 55, type: 'Ground' },
    'Poison Tail': { bp: 60, type: 'Poison', makesContact: true },
    'Shadow Punch': { bp: 75, type: 'Ghost', makesContact: true },
    'Shock Wave': { bp: 60, type: 'Electric' , target: 'allAdjacentFoes' },
...
var DPP_PATCH = {
    ...
    'Gunk Shot': { bp: 140, type: 'Poison', category: 'Physical' , recoil: [44, 100] },
    'Gyro Ball': {
        bp: 0,
        type: 'Steel',
        makesContact: true,
    ...
    'Roar of Time': { bp: 140, type: 'Dragon', category: 'Special' , recoil: [44, 100] },
    'Rock Climb': {
        bp: 90,
        type: 'Rock',
        makesContact: true,
    ...
    'Spacial Rend': { bp: 140, type: 'Dragon', category: 'Physical' , recoil: [44, 100] },
    'Trump Card': {
        bp: 140,
        type: 'Normal',
        makesContact: true,
    ...
    'Focus Blast': { bp: 140, type: 'Fighting', category: 'Special', recoil: [44, 100] },
    'Force Palm': {
        bp: 60,
        type: 'Fighting',
        makesContact: true,
    ...
    'Rock Wrecker': { bp: 140, type: 'Rock', category: 'Special' , recoil: [44, 100] },
...
var BW_PATCH = {
    ...
    'Doom Desire': { bp: 140 , recoil: [44, 100] },
    ...
    'Flare Blitz': { secondaries: true, recoil: [44, 100] },
    ...
    'Volt Tackle': { secondaries: true, recoil: [44, 100] },
    ...
    Soak: { bp: 0, type: 'Water' , priority: 1 },
    Steamroller: {
        bp: 65,
        type: 'Bug',
        makesContact: true,
...
var XY_PATCH = {
    ...
    Lick: { bp: 30 },
    'Low Sweep': { bp: 65 },
    'Meteor Mash': { bp: 140 , recoil: [44, 100] },
    'Muddy Water': { bp: 90 },
    ...
    'Thousand Arrows': { bp: 100, type: 'Ground', target: 'allAdjacentFoes', category: 'Physical' },
    ...
    'Land\'s Wrath': { bp: 140, type: 'Ground', target: 'allAdjacentFoes', category: 'Special' , recoil: [44, 100] },
    'Light of Ruin': { bp: 140, type: 'Fairy', recoil: [44, 100], category: 'Special' },
    'Oblivion Wing': {
        bp: 140,
        type: 'Flying',
        recoil: [44, 100],
    ...
    Belch: { bp: 140, type: 'Poison', category: 'Special' , recoil: [44, 100] },
    Boomburst: {
        bp: 140,
        type: 'Normal',
        isSound: true,
    ...
    Celebrate: { bp: 60, type: 'Fairy' , category: 'Physical' , secondaries: true},
    ...
    'Fairy Wind': { bp: 60, type: 'Fairy', category: 'Special' , secondaries: true },
    ...
    'Happy Hour': { bp: 140, type: 'Water' , category: 'Physical' , recoil: [1, 1] },
    'Hold Back': {
        bp: 40,
        type: 'Normal',
        makesContact: true,
    ...
    'Hold Hands': { bp: 40, type: 'Bug' , category: 'Physical', multihit: 2 , secondaries: true , priority: 1},
    Infestation: { bp: 35, type: 'Bug', makesContact: true, category: 'Special' },
...
var SM_PATCH = {
    ...
    Leafage: { bp: 50, type: 'Grass', category: 'Physical', zp: 100 , secondaries: true },
    Liquidation: {
        bp: 85,
        type: 'Water',
        makesContact: true,
...
var SS_PATCH = {
    ...
    Rage: { maxPower: 90 },
    'Rapid Spin': { bp: 40, secondaries: true, maxPower: 100 },
